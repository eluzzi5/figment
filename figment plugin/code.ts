  ...
  if (selection.length === 0){
    ...
    if ((selection[0].type === "RECTANGLE") || (selection[0].type === "FRAME")){
      if(selection[0].type === "RECTANGLE"){
        const iThinkThisIsRect = figma.currentPage.selection[0] as RectangleNode;
        const selected_image = iThinkThisIsRect.name;
        figma.ui.postMessage({ type: 'image-selected',selected_image});
      }
      if(selection[0].type === "FRAME"){
        const iThinkThisIsFrame = figma.currentPage.selection[0] as FrameNode;
    ...
    if ((selection[0].type === "TEXT") || (selection[0].type === "STICKY") || (selection[0].type === "FRAME") || (selection[0].type === "SHAPE_WITH_TEXT")){
      if (selection[0].type === 'TEXT') {
        const iThinkThisIsText = figma.currentPage.selection[0] as TextNode;
        ...
        const iThinkThisIsSticky = figma.currentPage.selection[0] as StickyNode;
        ...
        const iThinkThisIsShape = figma.currentPage.selection[0] as ShapeWithTextNode;
